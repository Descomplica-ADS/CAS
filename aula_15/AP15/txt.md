...
switch(op) {
    case '1':
        ...
        if(x > 0 && y > 0) { msgCalc += "Produto de " + x + " x " + y + " = " + x * y + space2x; }

        JOptionPane.showMessageDialog(null, msgCalc);
        break;
    case '2':
        ...
        msgCalc += "Produtória de " + x + ", " + y + " vezes é: " + z + space2x;

        JOptionPane.showMessageDialog(null, msgCalc);
        break;
    default: JOptionPane.showMessageDialog(null, msgArg, "Ops!", JOptionPane.ERROR_MESSAGE);
}
```
...
public class AP15 {
	...
	public static void main(String[] args) {
		...
		String
			msgCalc = "",
			msgInvalid = "Opção invalida, cálculos não realizados.",
			msgInitial =
